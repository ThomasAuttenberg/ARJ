  ...
  <div>
    ...
    <FAQBlock id="faq" v-intersection="[fd,2]"
      ...
      :items = "[
        ...
        {title: 'Застрахован ли груз?', content:'Компания «АРД» несет полную материальную ответственность за вверенное имущество и принятые на себя обязательства, в рамках действующего законодательства Республики Казахстан и Российской Федерации'},
        {title: 'Какой пакет документов требуется к перевозке?',content:'Для физических лиц - опись перевозимого груза; CMR; СНТ; код ТН ВЭД (в случае отсутствия данных документов, компания “АРД” содействует в формировании пакета документов).\n'+
